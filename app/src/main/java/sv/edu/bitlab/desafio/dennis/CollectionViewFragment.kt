        ...
        db.collection("accounts")
            ...
            .addOnSuccessListener {result->
                for (document in result) {
                    ...
                    accountsColl.add(Account("${document.data["accountName"]}", "${document.data["accountEmail"]}", "${document.data["accountPhone"]}", "${document.data["accountFoundOutBy"]}", "${document.data["accountImage"]}" ))
